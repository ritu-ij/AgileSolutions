    ...
    return (
        <div id="landing-container">
            ...
            <section className="solutions-container">
                <button class="solution" onClick={(ev) => { route(ev, `/poker`) }}>Planning Poker</button>
                <button class="solution" onClick={(ev) => { route(ev, `/Retrospective/Dashboard`) }}>Retrospective</button>
            </section>
            <footer>
                by Agile Agents
            </footer>
